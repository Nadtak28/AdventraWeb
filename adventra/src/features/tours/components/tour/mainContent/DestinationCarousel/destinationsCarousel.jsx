      ...
      <section className="mt-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => scroll("left")}
              className="p-2 bg-[#519489]/10 text-[#519489] cursor-pointer rounded-xl hover:bg-[#519489]/20 transition-colors"
            >
        ...
        >
          {cities?.map((city) => (
            ...
            >
              <div className="bg-gradient-to-br from-white dark:from-gray-800 dark:to-gray-900  rounded-2xl shadow-sm border border-gray-100 overflow-hidden group-hover:shadow-lg transition-all duration-300 group-hover:border-[#519489]/20">
                {/* <div
                ...
                /> */}
                <div className="p-6">
                  <h3 className="text-xl dark:text-white font-bold text-gray-900 mb-2">
                    {city.name}
                  </h3>
